...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center bg-linear-to-br from-[#f0e8dd] via-[#f0e8dd]/70 to-[#e6dccf] text-[#8B4513] overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <h1 className="text-4xl md:text-6xl font-bold leading-tight">
              Adote um amigo e <span className="text-[#FF7A00]">transforme uma vida</span> 🐶🐱
            </h1>

            {/* Description */}
            <p className="text-lg text-[#8B4513] max-w-xl">
              Encontre seu novo melhor amigo e adote um animal de estimação com  a <span className='font-bold text-[#ff7a00]'>🐾 Adopt a Friend 🐾</span>
            </p>
